...
const BaseBezierEasing = Easing.bezier(0.4, 0.0, 0.7, 1.0);
...
export class SpinnerAnimation extends Animation {
    constructor(arcSize, config) {
        ...
        this.toStyleTransformProp = (rotate, source = {}) => {
            ...
            return Object.assign(Object.assign({}, source), { transform });
        };
        /**
    ...
    get animation() {
        return Animated.timing(this.animationValue, Object.assign({ toValue: 1.0 }, this.config));
    }
    start(callback) {
