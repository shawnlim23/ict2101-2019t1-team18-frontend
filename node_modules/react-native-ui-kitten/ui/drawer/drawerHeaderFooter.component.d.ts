...
import { ListItemProps, ListItemElement } from '../list/listItem.component';
export declare type DrawerHeaderFooterProps = Partial<ListItemProps>;
export declare type DrawerHeaderFooterElement = ListItemElement;
/**
 ...
 * ```
 */
export declare class DrawerHeaderFooter extends React.Component<DrawerHeaderFooterProps> {
    render(): DrawerHeaderFooterElement;
}
