...
export class CalendarDataService {
    constructor(dateService) {
        ...
        this.createMonthPickerData = (date, rows, columns) => {
            ...
            const monthRange = range(rows * columns, (index) => {
                ...
                return Object.assign({ date: monthDate }, DEFAULT_DATE_OPTIONS);
            });
        ...
        this.createYearPickerData = (date, rows, columns) => {
            ...
            const yearRange = range(rows * columns, (index) => {
                ...
                return Object.assign({ date: yearDate }, DEFAULT_DATE_OPTIONS);
            });
    ...
    withRangedStartDates(days, startDate) {
        return days.map((day) => {
            ...
            return isSameStartDate ? Object.assign(Object.assign({}, day), { range: true }) : day;
        });
    }
    withRangedStartEndDates(days, startDate, endDate) {
        return days.map((day) => {
            ...
            if (isSameStartDate || isSameEndDate) {
                return Object.assign(Object.assign({}, day), { range: true });
            }
            else {
                const isInRange = this.dateService.isBetween(day.date, startDate, endDate);
                return Object.assign(Object.assign({}, day), { range: isInRange });
            }
        });
    }
    ...
    createPrevBoundingDays(activeMonth, numberOfBoundingDates) {
        ...
        return this.createDateRangeForMonth(month, DEFAULT_DATE_OPTIONS)
            ...
            .map((date) => {
            return Object.assign(Object.assign({}, date), { bounding: true });
        });
    }
    ...
    getWeekStartDiff(date) {
        return (DateService.DAYS_IN_WEEK
            ...
            + this.dateService.getDayOfWeek(date)) % DateService.DAYS_IN_WEEK;
    }
    ...
    createDateRangeForMonth(monthDate, options) {
        ...
        return range(daysInMonth, (i) => {
            ...
            return Object.assign({ date }, options);
        });
    }
}
