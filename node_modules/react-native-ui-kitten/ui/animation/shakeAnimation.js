...
export class ShakeAnimation extends Animation {
    ...
    get animation() {
        ...
        const startAnimation = Animated.timing(this.value, Object.assign({ toValue: this.counter % 2 !== 0 ? -offset : offset }, restConfig));
        const endAnimation = Animated.timing(this.value, Object.assign({ toValue: this.counter % 2 !== 0 ? offset : -offset }, restConfig));
