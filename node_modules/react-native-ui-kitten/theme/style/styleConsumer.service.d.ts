 ...
 */
import { ContextProps, StyledComponentProps } from './styleConsumer.component';
...
export declare class StyleConsumerService {
    ...
    withStyledProps<P extends object>(source: P, context: ContextProps, interaction: Interaction[]): P & StyledComponentProps;
