...
describe('navigation options', () => {
    ...
    it('calls store if component has passProps', () => {
        ...
        uut.processOptions(options);
        ts_mockito_1.verify(mockedStore.setPropsForId('CustomComponent1', passProps)).called();
    });
    ...
    it('calls store when button has passProps and id', () => {
        ...
        uut.processOptions(options);
        ts_mockito_1.verify(mockedStore.setPropsForId('1', passProps)).called();
    });
    ...
    it('calls store when component has passProps component id and values', () => {
        ...
        ts_mockito_1.verify(mockedStore.setPropsForId('component1', props)).called();
