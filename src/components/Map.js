        ...
        return (
            ...
            {/* <View style={{
             ...
             <View style ={{
                ...
                {!this.state.started_route ? (<Button color="#ff5c5c" title={this.state.started_journey ? "Cancel Journey" : "Start Journey"} onPress={() => this.generateFMLM(this.state.destination)}></Button>) : null}
